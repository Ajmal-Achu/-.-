...
`.trim()
    await conn.send2ButtonLoc(m.chat, await (await fetch("https://raw.githubusercontent.com/DEVILSER/DEVILSER/main/Media/Ammu/Ammukutty-407x400.png")).buffer(), devil, '© ⁩ᴍᴀᴅᴀʀᴀ.ᴜᴄʜɪʜᴀ⁴̅⁰͍³〆', 'ᴍᴇɴᴜ', '.? menu', 'ᴏᴡɴᴇʀ', ',owner' )
}
handler.tags = ['main']
handler.help = ['rules']
