    ...
    try {
        if (m.mentionedJid.includes(this.user.jid) && m.isGroup) {
            await this.send2Button(m.chat,
                isBanned ? '⁨ᴍᴀᴅᴀʀᴀ.ᴜᴄʜɪʜᴀ⁴̅⁰͍³〆⁩ is not active' : banned ? 'you are banned' : 'ᴍᴀᴅᴀʀᴀ.ᴜᴄʜɪʜᴀ⁴̅⁰͍³〆⁩ Here',
                '© ⁨ᴍᴀᴅᴀʀᴀ.ᴜᴄʜɪʜᴀ⁴̅⁰͍³〆⁩',
...
https://github.com/w4lk36efx
`.trim(), '© ᴍᴀᴅᴀʀᴀ.ᴜᴄʜɪʜᴀ⁴̅⁰͍³〆', ' Owner', ',owner', m)
    }
